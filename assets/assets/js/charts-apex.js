...
!(function () {
	...
	const c = document.querySelector("#lineAreaChart"),
		d = {
			chart: {
				height: 400,
				type: "area",
	...
	const h = document.querySelector("#barChart"),
		p = {
			chart: {
				height: 400,
				type: "bar",
	...
	const f = document.querySelector("#scatterChart"),
		m = {
			chart: {
				height: 400,
				type: "scatter",
	...
	if (void 0 !== typeof f && null !== f) {
		new ApexCharts(f, m).render();
	}
	const b = document.querySelector("#lineChart"),
		g = {
			chart: {
				height: 400,
				type: "line",
	...
	if (void 0 !== typeof b && null !== b) {
		new ApexCharts(b, g).render();
	}
	const x = document.querySelector("#horizontalBarChart"),
		u = {
	...
	if (void 0 !== typeof x && null !== x) {
		new ApexCharts(x, u).render();
	}
	const y = document.querySelector("#candleStickChart"),
		w = {
			chart: {
				height: 410,
				type: "candlestick",
	...
	if (void 0 !== typeof y && null !== y) {
		new ApexCharts(y, w).render();
	}
	const S = document.querySelector("#heatMapChart"),
		C = {
			chart: {
				height: 350,
				type: "heatmap",
	...
	if (void 0 !== typeof S && null !== S) {
		new ApexCharts(S, C).render();
	}
	const k = document.querySelector("#radialBarChart"),
		z = {
	...
	if (void 0 !== typeof k && null !== k) {
		new ApexCharts(k, z).render();
	}
	const v = document.querySelector("#radarChart"),
		A = {
			chart: {
				height: 350,
				type: "radar",
	...
	if (void 0 !== typeof v && null !== v) {
		new ApexCharts(v, A).render();
	}
	const O = document.querySelector("#donutChart"),
		D = {
