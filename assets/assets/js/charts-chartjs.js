...
!(function () {
	...
	let l, n, d, s, c;
	isDarkStyle
		? ((l = config.colors_dark.cardColor),
	...
	const b = document.getElementById("horizontalBarChart");
	if (b) {
		new Chart(b, {
			type: "bar",
			data: {
	...
	const y = document.getElementById("lineChart");
	if (y) {
		new Chart(y, {
			type: "line",
			data: {
	...
	if (C) {
		const o = C.getContext("2d").createLinearGradient(0, 0, 0, 150);
		o.addColorStop(0, "rgba(85, 85, 255, 0.9)"),
			o.addColorStop(1, "rgba(151, 135, 255, 0.8)");
		const r = C.getContext("2d").createLinearGradient(0, 0, 0, 150);
		r.addColorStop(0, "rgba(255, 85, 184, 0.9)"),
			r.addColorStop(1, "rgba(255, 135, 135, 0.8)");
		new Chart(C, {
			type: "radar",
			data: {
	...
	const u = document.getElementById("bubbleChart");
	if (u) {
		new Chart(u, {
			type: "bubble",
			data: {
	...
	const x = document.getElementById("lineAreaChart");
	if (x) {
		new Chart(x, {
			type: "line",
			data: {
	...
	const m = document.getElementById("scatterChart");
	if (m) {
		new Chart(m, {
			type: "scatter",
			data: {
