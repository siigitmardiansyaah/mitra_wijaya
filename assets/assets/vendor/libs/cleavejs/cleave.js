											...
											0 === o.length
												...
												: a.reduce(function (e, t) {
														switch (t) {
															case "d":
																return (
																	e + (0 === o[0] ? "" : n.addLeadingZero(o[0]))
																);
															case "m":
																return (
																	e + (0 === o[1] ? "" : n.addLeadingZero(o[1]))
																);
															case "y":
																return (
																	e +
																	(p ? n.addLeadingZeroForYear(o[2], !1) : "")
																);
															case "Y":
																return (
																	e +
																	(p ? n.addLeadingZeroForYear(o[2], !0) : "")
																);
														}
												  }, "")
										);
										...
										for (
											var r,
												...
												o = (e = (e = (e = e.replace(/[^\d+]/g, ""))
													.replace(/^\+/, "B")
													.replace(/\+/g, "")
													.replace("B", "+")).replace(t.delimiterRE, ""))
													.length;
											a < o;
											a++
										)
