            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <form id="formAuthentication" class="mb-3" action="<?php echo base_url()?>auth/proses_reset" method="POST">
                        <div class="mb-3">
                                <label for="email" class="form-label">Email</label>
                                <input type="text" class="form-control" id="email" name="email" placeholder="Enter your email" autofocus>
                                <input type="hidden" class="form-control" id="kode" name="kode" value="<?php echo $kode ?>" placeholder="Enter your email" autofocus>
                        </div>    
