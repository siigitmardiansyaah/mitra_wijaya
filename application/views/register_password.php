            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-2">Register Password 🔒</h4>
                        ...
                        <form id="formAuthentication" class="mb-3" action="<?php echo base_url()?>auth/registerPassword" method="POST">
                        <div class="mb-3">
                                <label for="email" class="form-label">Email</label>
                                <input type="text" class="form-control" id="email" name="email" placeholder="Enter your email" autofocus>
                        </div>
                        <div class="mb-3">
                                <label for="email" class="form-label">Kode Reset</label>
                                <input type="text" class="form-control" id="email" name="kode_reset" placeholder="Enter Kode Reset" autofocus>
                        </div>      
