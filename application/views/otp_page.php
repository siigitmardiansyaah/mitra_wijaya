      ...
      <div class="card">
        <div class="card-body">
          ...
          <p class="text-start mb-4">
            Kode OTP dikirim, Silahkan cek inbox atau spam Email anda
            <span class="fw-medium d-block mt-2" style="font-weight: bold;"><?php echo $this->session->userdata('email') ?></span>
          </p>
          <p class="mb-0 fw-medium">Ketikkan 6 digit kode OTP Anda</p>
          <form id="twoStepsForm" action="<?php echo base_url() ?>auth/proses_otp" method="POST">
