            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Enter your email and we'll send you instructions to regis your password</p>
                        ...
                        <?php endif; ?> 
                        <form id="formAuthentication" class="mb-3" action="<?php echo base_url()?>auth/send_link_regis" method="POST">
                            <div class="mb-3">
