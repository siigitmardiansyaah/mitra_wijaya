        ...
        <div class="authentication-inner">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form id="twoStepsForm" action="<?php echo base_url() ?>integrasi/prosesOTP" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="hidden" name="url_callback" value="<?php echo $url ?>" />
                        ...
                        <?php if ($kode == 1 || $kode == 2) : ?>
                            <a href="<?php echo base_url() ?>integrasi/integrasi_qris" class="btn btn-secondary d-grid w-100 mb-3">Kembali</a>
                        <?php else : ?>
                            <a href="<?php echo base_url() ?>integrasi/transaksi_ip" class="btn btn-secondary d-grid w-100 mb-3">Kembali</a>
                        <?php endif; ?>
                        <div>
