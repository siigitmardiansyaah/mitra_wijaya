...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="py-3 mb-4">
        <span class="text-muted fw-light"><a href="<?php echo base_url() ?>dashboard">Home</a> / Dana /</span> Mutasi Dana
    </h4>
    <div class="row">
        <div class="col-xxl">
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center justify-content-between">
                    <h5 class="mb-0">Mutasi Dana</h5>
                </div>
                ...
                <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="form-group col-md-3">
                                    <label class="col-form-label" for="basic-icon-default-fullname">Tanggal Permohonan (Dari)</label>
                                    <div class="input-group input-group-merge">
                                        <input class="form-control" type="date" name="tgl_permohonan1" id="html5-date-input1" />
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="col-form-label" for="basic-icon-default-fullname">Tanggal Permohonan (Sampai)</label>
                                    <div class="input-group input-group-merge">
                                        <input class="form-control" type="date" name="tgl_permohonan2" id="html5-date-input2" />
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="col-form-label" for="basic-icon-default-fullname">Tanggal Pembayaran (Dari)</label>
                                    <div class="input-group input-group-merge">
                                        <input class="form-control" type="date" name="tgl_pembayaran1" id="html5-date-input3" />
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="col-form-label" for="basic-icon-default-fullname">Tanggal Pembayaran (Sampai)</label>
                                    <div class="input-group input-group-merge">
                                        <input class="form-control" type="date" name="tgl_pembayaran2" id="html5-date-input4" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="text" name="keterangan" class="form-control" id="basic-icon-default-fullname9" placeholder="Keterangan" aria-label="John Doe" aria-describedby="basic-icon-default-fullname2" />
                                ...
                                <div class="form-group col-md-12">
                                    <div class="input-group input-group-merge">
                                        <div class="demo-inline-spacing">
                                            ...
                                            <button type="button" class="btn btn-outline-warning" id="btnResetMD">
                    ...
                    <hr class="mt-0">
                    <br/>
                    <h4 style="text-transform: uppercase;font-weight: bold;">List History Mutasi Dana</h4>
                    <div class="card-datatable table-responsive">
                        <table class="dt-advanced-search table border-top table" id="tableMutasi">
                            <thead>
                                <tr>
