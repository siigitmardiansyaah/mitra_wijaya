            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="mb-4">Masukkan Email, dan kami akan kirimkan link untuk reset password</p>
                        ...
                        <?php endif; ?> 
                        <form id="formAuthentication" class="mb-3" action="<?php echo base_url()?>auth/send_link" method="POST">
                            <div class="mb-3">
